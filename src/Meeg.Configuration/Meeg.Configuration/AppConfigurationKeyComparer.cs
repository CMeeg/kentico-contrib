...
namespace Meeg.Configuration
{
    ...
    /// </summary>
    internal class AppConfigurationKeyComparer : IComparer<string>
    {
        private static readonly string[] KeyDelimiterArray = { AppConfigurationPath.KeyDelimiter };

        /// <summary>
        /// The default instance.
        /// </summary>
        public static AppConfigurationKeyComparer Instance { get; } = new AppConfigurationKeyComparer();
        ...
        {
            var xParts = x?.Split(KeyDelimiterArray, StringSplitOptions.RemoveEmptyEntries)
                ?? Array.Empty<string>();

            var yParts = y?.Split(KeyDelimiterArray, StringSplitOptions.RemoveEmptyEntries)
                ?? Array.Empty<string>();
