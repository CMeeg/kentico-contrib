# Meeg.Kentico.Configuration.Cms.Admin

Thanks for installing the Configuration module!

* If you are updating from a previous version, please see the [changelog](https://github.com/CMeeg/kentico-contrib/tree/master/src/Meeg.Kentico.Configuration/CHANGELOG.md) for a description of all notable changes to this project
...
Now you can use the Configuration module!

Please read through the [documentation](https://github.com/CMeeg/kentico-contrib/tree/master/src/Meeg.Kentico.Configuration) if this is the first time you have used the module.
