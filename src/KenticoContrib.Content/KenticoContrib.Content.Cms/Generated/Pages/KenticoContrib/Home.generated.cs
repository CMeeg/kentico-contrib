...
namespace CMS.DocumentEngine.Types.KenticoContrib
{
	...
	public partial class Home : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "KenticoContrib.Home";
		...
		/// </summary>
		[DatabaseField]
		public string HomeMetadata
		{
			get
			{
				return ValidationHelper.GetString(GetValue("HomeMetadata"), @"");
			}
			set
			{
				SetValue("HomeMetadata", value);
			}
		}
		...
		public partial class HomeFields : AbstractHierarchicalObject<HomeFields>
		{
			...
			public string Metadata
			{
				get
				{
					return mInstance.HomeMetadata;
				}
				set
				{
					mInstance.HomeMetadata = value;
				}
			}
		}
