...
public class OnlineMarketingMacroRuleEditExtender : MacroRuleEditExtender
{
    ...
    private void ShowMacroWarning(object sender, EventArgs e)
    {
        ...
        if (info != null)
        {
            ...
            {
                var text = string.Format(CoreServices.Localization.GetString("om.configuration.macro.slow"), DocumentationHelper.GetDocumentationTopicUrl("om_macro_performance"));
