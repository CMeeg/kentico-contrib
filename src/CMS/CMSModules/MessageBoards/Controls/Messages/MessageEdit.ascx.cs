...
public partial class CMSModules_MessageBoards_Controls_Messages_MessageEdit : CMSAdminEditControl
{
    ...
    private IMessageBoardActivityLogger mMessageBoardActivityLogger = Service.Resolve<IMessageBoardActivityLogger>();
    ...
    private void LogRatingActivity(double value)
    {
        ...
        {
            var ratingActivityLogger = Service.Resolve<IRatingActivityLogger>();
