<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_UserContributions_ContributionList"  Codebehind="~/CMSWebParts/UserContributions/ContributionList.ascx.cs" %>
