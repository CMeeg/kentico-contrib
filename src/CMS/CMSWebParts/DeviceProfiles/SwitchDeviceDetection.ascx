<%@ Control Language="C#" AutoEventWireup="true"  Codebehind="~/CMSWebParts/DeviceProfiles/SwitchDeviceDetection.ascx.cs" Inherits="CMSWebParts_DeviceProfiles_SwitchDeviceDetection" %>
