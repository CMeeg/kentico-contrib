<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Newsletters_NewsletterUnsubscriptionWebPart"  Codebehind="~/CMSWebParts/Newsletters/NewsletterUnsubscriptionWebPart.ascx.cs" %>
